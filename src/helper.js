...
function newAccountField(l, i, name, value) {
  ...
  // sort fields
  list["children"][l]["children"][i]["fields"] = list["children"][l][
    "children"
  ][i]["fields"].sort(function (a, b) {
...
function sortAccounts(l) {
  list["children"][l]["children"] = list["children"][l]["children"].sort(
    function (a, b) {
...
function createTooltip(text, xoffset, above) {
  ...
  if (above == true) {
    tooltip.style.transform =
      "translateY(-26px) translateX(-" + xoffset + "px)";
  } else {
...
function newList(type) {
  ...
  if (type == "block") {
    list["children"].unshift({
      children: [{ name: "SUBLIST", children: [] }],
      name: "New List",
      type: "block",
      creationDate: d.getTime(),
      locked: false,
...
function sendItemToTop(l, i, e) {
  list["children"][l]["children"][i]["children"].unshift(
    list["children"][l]["children"][i]["children"].splice(e, 1)[0]
  );
}
